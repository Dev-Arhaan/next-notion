    ...
    <>
        ...
        ">
            ...
            >
              ...
              key={client.alt} className="relative
              w-[200px]
              m-20
              shrink-0
              flex
        ...
        <div className="w-[30%]
          ...
          top-22" />
            ...
            <TitleSection title="Trusted by all"
              ...
              pill="Testimonials"
              />
              {[...Array(2)].map((arr, index) => (<div key={randomUUID()}
        ...
        className='mt-4 px-4 sm:px-6'>
          <TitleSection title="Trusted by all"
              ...
              pill="Testimonials"
              />
          <div className='flex flex-col-reverse sm:flex-row gap-4 justify-center sm:items-stretch
          items-center mt-10'>
